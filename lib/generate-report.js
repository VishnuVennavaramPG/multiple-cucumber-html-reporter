  ...
  function processAllFeatures() {
    ...
    function getObjectWithPercentagesBasedOnCountryForFeatures(filteredFeatures) {
      ...
      const percentageObject=  {
        featuresPassPercentage: suite.featureCount.passedPercentage,
        featuresFailPercentage: suite.featureCount.failedPercentage,
        featuresCount : suite.featureCount.total,
        scenariosPassPercentage: suite.scenarios.passedPercentage,
        scenariosFailPercentage: suite.scenarios.failedPercentage,
        scenariosCount: suite.scenarios.total,
      }
